        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col items-start gap-8 text-left max-w-2xl">
            ...
            <p className="text-xl leading-relaxed text-text-muted dark:text-slate-300 text-balance font-medium">
              Premium aromalar, el yapımı külahlar ve sıfır pişmanlık. En
              sevdiğiniz dondurmaları sipariş edin, 30 dakika içinde kapınıza
              taptaze gelsin.
            </p>
          ...
          <div className="relative lg:block perspective-1000">
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDSCl4swLAGNfnMlRICuudppm30teCTNywXQmmwG2eG1uBtXrf9kJrFUFNKOSXLxIPtnRpzXIgo-l6JRbqEQ9-L7SC_khzpQ97MI6DeDwss2rNm8deWlTqv-NlIVTGqXfEk4uhFbwikBvCqGMGB_XwgJqNtIb0e19DL52ErNsjlnbP__rzGwg0UJHzbUaSVobq-kkhrA3bv6chMaHs6KsZZjlDgEg7xJMUj4Ko1VTqApPvld8Fy6Gfe4x_W2kI1joV3i570HO4dewun')",
                }}
              ></div>
