    ...
    <div className="flex gap-4">
      ...
      <div className="flex flex-1 flex-col justify-between py-0.5">
        ...
        <div className="flex items-center justify-between mt-1">
          ...
          <div className="flex items-center gap-3 rounded-lg border border-slate-200 bg-white px-1 py-0.5 shadow-sm dark:border-white/10 dark:bg-white/5">
            <button
              onClick={decrement}
              className="flex h-6 w-6 items-center justify-center rounded text-xs text-slate-400 hover:text-primary dark:text-slate-400 dark:hover:text-white"
            >
              -
            </button>
            <span className="w-3 text-center text-xs font-bold text-slate-900 dark:text-white">
              {item.quantity}
            </span>
            <button
              onClick={increment}
