...
const ProductList = () => {
  ...
  if (isLoading) {
    return (
      <div data-testid="loading" className="flex justify-center items-center min-h-[400px]">
  ...
  return (
    <section className="bg-background-light py-20 dark:bg-background-dark relative" id="menu">
      <div
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        <div className="mb-12 flex flex-col items-start justify-between gap-6 border-b border-slate-200 pb-8 dark:border-white/10 lg:flex-row lg:items-end">
          <div>
            <h3 className="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Aromalarımız</h3>
        ...
        {products.length === 0 ? (
          <p className="text-center text-gray-500 py-10 dark:text-slate-400">Aroma bulunamadı.</p>
        ) : (
