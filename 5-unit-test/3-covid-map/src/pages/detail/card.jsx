const Card = ({ item }) => {
  return (
    <div className="p-6 border border-gray-200 text-black shadow-md hover:shadow-lg rounded-2xl bg-linear-to-br from-white to-gray-50 transition-all duration-300 hover:scal-105 hover:-translate-y-1 group">
