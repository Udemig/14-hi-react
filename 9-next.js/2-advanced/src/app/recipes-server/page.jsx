...
// statik bir sayfa içeriğini belirli aralıklarla tekrar oluşturulmasını ve verilerin tazelenmesini sağlar
    ...
    <div className="border border-blue-500 p-5">
      ...
      {data?.recipes?.map((recipe) => (
        <Link
          ...
          key={recipe.id}
          className="flex gap-5 mt-5 p-5 rounded-md border text-white! text-2xl!"
        >
