      ...
      <div className="flex items-center gap-5">
        ...
        <Link href="/cart" className="header-link">
          <div className="relative">
            ...
            <span className="absolute -right-3.75 -top-5 shadow font-bold text-sm text-shadow-xl bg-green-500 text-white size-6 grid place-items-center rounded-full">
              {totalAmount}
            </span>
          </div>
