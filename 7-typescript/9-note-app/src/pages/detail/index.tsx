    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between sm:items-center gap-4 animate-fade-in">
        ...
        <div className="flex gap-3">
          <Link
            to={`/edit/${id}`}
            className="flex items-center justify-center px-4 py-2 rounded-md shadow-sm text-white bg-primary hover:bg-primary/80 transition"
          >
