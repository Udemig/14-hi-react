  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-5">
        <h1 className="text-2xl md:text-3xl">Ürünler</h1>

        <Link
          to="/admin/create"
          className="bg-my-blue px-4 py-1 md:px-6 md:py-2 rounded-md text-white hover:brightness-75 transition"
        >
          Ürün Ekle
        </Link>
      </div>
            ...
            {data?.map((product) => (
              <tr className="bg-white border-b hover:bg-gray-50 font-semibold">
                ...
                <td className="p-4 space-x-4">
                  ...
                  <button className="text-red-600 hover:underline md:ps-3">Sil</button>
                </td>
              </tr>
            ))}
          </tbody>
